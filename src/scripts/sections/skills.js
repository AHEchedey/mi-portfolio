/**
 * Ownership: Sections Team (Skills)
 * Purpose: Modular Skills pilot logic with safe legacy coexistence.
...
function createSkillsModule() {
  ...
  return {
    ...
    destroy() {
      ...
      delete state.el.dataset.skillsModule;
      state.el = null;
...
export default createSkillsModule();
